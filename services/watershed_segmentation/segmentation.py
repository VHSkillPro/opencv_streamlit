...
def license_plate_watershed_segmentation(img: np.ndarray, kernel: np.ndarray, thres: float) -> cv2.typing.MatLike:
    """
    ...
    _, thresh = cv2.threshold(gray_scale, 0, 255, cv2.THRESH_BINARY_INV + cv2.THRESH_OTSU)
